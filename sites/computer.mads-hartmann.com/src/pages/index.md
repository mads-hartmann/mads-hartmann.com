...
<p>I’m using <a href="https://arc.net/">Arc</a> as my default browser</p>
<ul>
...
<h2 id="heading-cleanshot-x">CleanShot X</h2>
<p>I use <a href="https://cleanshot.com/">CleanShot X</a> as a replacement for the macOS native Screenshot application. The annotation features and flows of CleanShot X are just superb ✨</p>
<h2 id="heading-pixelsnap-2">PixelSnap 2</h2>
<p>I’m giving <a href="https://pixelsnap.com/">PixelSnap</a> a try. I haven’t used it much yet, but I really like the idea of it and in the past something like this would have made my life easier, so bought it just so I have it handy for the next time - 27 June, 2025 </p>
<h2 id="heading-hyperkey">Hyperkey</h2>
<p>I’m using <a href="https://hyperkey.app/">Hyperkey</a> to map the right ⌘ to ^⌥⌘⇧ as that allows me to introduce keybindings that are extremely unlikely to conflict with exiting keybindings. I use this mostly for Rastcast commands.</p>
<h2 id="heading-karabiner-elements">Karabiner Elements</h2>
<p><em>[Experimental]</em>: Trying it out - with my Keychron Q10 I needed a way to have arrow keys in the home-row</p>
<ul>
<li>I had to set the Virtual Keyboard to ISO manually</li>
<li>⇪ maps to ^<br>This is something I started doing back when I was a heavy Emacs users and now the muscle memory is stuck with me.</li>
<li><code>⌘^hjkl</code> maps to ←↓↑→ so I can navigate from the home-row<br>I would have preferred to just use ^ but that would conflict with ^k which I use to delete lines; again, back from my Emacs days.</li>
<li>TODO: ^<spacebar> to emulate Emacs’ <a href="https://www.gnu.org/software/emacs/manual/html_node/emacs/Mark.html">mark</a> functionality</li>
</ul>
...
<h2 id="heading-raycast">Raycast</h2>
...
<h3 id="heading-built-in-extensions">Built-in Extensions</h3>
...
<li><strong>Screenshots</strong><br>Nice and quick way to be able to search your screenshots. By default it searches the location you’ve configured <del>Screenshot</del> CleanShot X to use.</li>
<li><strong>Clipboard History</strong><br>I use this all the time. I have this mapped to ◆C</li>
<li><strong>Snippets</strong><br>It took me a while to start using snippets, but I now have it mapped to ◆S and use it every day.</li>
</ul>
...
<li><a href="https://www.raycast.com/garrett/ray-so"><strong>ray.so</strong></a><br>Really easy way to create beautiful screenshots of code snippets.</li>
<li><a href="https://www.raycast.com/Haojen/toggle-desktop-visibility"><strong>Toggle Desktop Visibility</strong></a><br>I use this to toggle display files in the desktop. This is handy whenever I need to do a quick recording and don’t fancy everyone seeing how messy my desktop is.</li>
</ul>
...
<h2 id="heading-setting-up-a-new-mac">Setting Up a New Mac</h2>
...
<h3 id="heading-setting-up-nix">Setting up Nix</h3>
...
<h2 id="heading-havent-tried-yet-but-looks-great">Haven’t tried yet but looks great</h2>
<ul>
<li><a href="https://www.screen.studio/">Screen Studio</a> looks amazing. If I start sharing more videos I’ll definitely give this a try.</li>
</ul>
...
<h3 id="heading-week-25-2024">Week 25, 2024</h3>
<p>Started using CleanShot X as my Screenshot application. I should have done so much earlier.</p>
...
<h3 id="heading-week-5-2024">Week 5, 2024</h3>
<p>6th of February 2024: I’m trying out using Arc as my default browser for a bit</p>
<hr>
